...
12. `operations-http-entry.ts` owns #632A-B run-history/result-file reads, cancel/rerun and notifications after the same security boundary; unmatched traffic falls through to `worker/index.ts`;
