...
**Admin Dashboard Softrust / Portal** — локальное административное приложение, которое предоставляет собственную аутентификацию, UI, API, локальное хранилище и интеграции с FreeIPA и XYOps.
