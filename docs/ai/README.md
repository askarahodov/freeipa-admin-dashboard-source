...
Этот документ — обязательная точка входа для ИИ-агентов, работающих с FreeIPA Admin Dashboard. Он не заменяет обычную инженерную документацию, а задаёт порядок чтения, правила достоверности и координацию при параллельной работе нескольких агентов.
