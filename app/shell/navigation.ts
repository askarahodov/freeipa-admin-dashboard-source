...
export const PRODUCT_NAV_GROUPS: readonly ProductNavGroup[] = [
  { id: "overview", items: [{ id: "overview", label: "Обзор", href: "/", icon: "dashboard" }] },
  { id: "directory", label: "DIRECTORY", items: [
  ...
  { id: "system", label: "SYSTEM", items: [{ id: "diagnostics", label: "Диагностика", href: "/diagnostics", icon: "diagnostics" }] },
  { id: "settings", items: [{ id: "settings", label: "Настройки", href: "/settings", icon: "settings" }] },
] as const;
