...
test("API reference tracks known literal storage route constants", async () => {
  const [api, status, integrity, preflight, apply] = await Promise.all([read("docs/reference/API.md"), read("src/storage/status/storage-status-contract.ts"), read("src/storage/integrity/storage-integrity-contract.ts"), read("src/storage/migration/preflight/storage-migration-preflight-contract.ts"), read("storage-migration-apply-contract.ts")]);
