...
Exact fields/read API/permissions belong to [`security/AUDIT_LOG.md`](AUDIT_LOG.md).
...
Liveness, readiness, dependency health and metrics are intentionally separate contracts. See [`HEALTH_CONTRACTS.md`](../operations/HEALTH_CONTRACTS.md) and [`HEALTH_METRICS.md`](../operations/HEALTH_METRICS.md).
...
- [`HEALTH_CONTRACTS.md`](../operations/HEALTH_CONTRACTS.md) — liveness/readiness/dependency semantics;
