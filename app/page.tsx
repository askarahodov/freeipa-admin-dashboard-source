  ...
  return (
    <div className="app-shell">
      ...
      <main className="main">
        ...
        {page === "automation" && <AutomationCatalog items={filteredCatalog} mode={catalogMode} meta={catalogMeta} error={catalogError} loading={catalogLoading} recentRuns={recentRuns} onSync={() => void syncCatalog()} onOpenSettings={() => setPage("settings")} onLaunch={setSelectedProcess} />}
