...
Architecture Decision Records (ADRs) capture accepted or proposed architectural decisions that materially affect runtime, data ownership, trust boundaries or deployment contracts.
