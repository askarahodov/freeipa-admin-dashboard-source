...
export const portalRouteContracts = [
  ...
  { id: "freeipa.users.list", method: "GET", path: "/api/integrations/users", owner: "worker/freeipa-base-read.ts", auth: "local-session", permission: "directory.read", mutation: "read", sameOrigin: false },
  ...
  { id: "freeipa.groups.list", method: "GET", path: "/api/integrations/groups", owner: "worker/freeipa-base-read.ts", auth: "local-session", permission: "directory.read", mutation: "read", sameOrigin: false },
