...
export const portalRouteContracts = [
  ...
  { id: "auth.logout", method: "POST", path: "/api/auth/logout", owner: "worker/local-secure-entry.ts", auth: "local-session", mutation: "mutation", sameOrigin: true },
  ...
  { id: "auth.users.create", method: "POST", path: "/api/auth/users", owner: "worker/local-secure-entry.ts", auth: "admin-session", mutation: "mutation", sameOrigin: true },
  { id: "auth.users.update", method: "PUT", path: "/api/auth/users/:userId", owner: "worker/local-secure-entry.ts", auth: "admin-session", mutation: "mutation", sameOrigin: true },
  { id: "auth.users.delete", method: "DELETE", path: "/api/auth/users/:userId", owner: "worker/local-secure-entry.ts", auth: "admin-session", mutation: "mutation", sameOrigin: true },
  ...
  { id: "settings.update", method: "PUT", path: "/api/integrations/settings", owner: "worker/settings-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "mutation", sameOrigin: true },
  ...
  { id: "settings.revisions.list", method: "GET", path: "/api/integrations/settings/revisions", owner: "worker/settings-lifecycle-entry.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "read", sameOrigin: false },
  { id: "settings.revisions.read", method: "GET", path: "/api/integrations/settings/revisions/:revision", owner: "worker/settings-lifecycle-entry.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "read", sameOrigin: false },

  { id: "freeipa.users.list", method: "GET", path: "/api/integrations/users", owner: "worker/freeipa-http-entry.ts", auth: "local-session", permission: "directory.read", mutation: "read", sameOrigin: false },
  ...
  { id: "freeipa.groups.list", method: "GET", path: "/api/integrations/groups", owner: "worker/freeipa-http-entry.ts", auth: "local-session", permission: "directory.read", mutation: "read", sameOrigin: false },
  ...
  { id: "integration.audit", method: "GET", path: "/api/integrations/audit", owner: "worker/integration-audit-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "read", sameOrigin: false },
  ...
  { id: "xyops.catalog.run", method: "POST", path: "/api/integrations/catalog/run", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "xyops.run", mutation: "mutation", sameOrigin: false },
  { id: "xyops.runs.list", method: "GET", path: "/api/integrations/runs", owner: "worker/operations-http-entry.ts", auth: "local-session", mutation: "read", sameOrigin: false },
  { id: "xyops.runs.file", method: "GET", path: "/api/integrations/runs/:runId/files/:fileId", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "directory.read", mutation: "read", sameOrigin: false },
  { id: "xyops.runs.cancel", method: "POST", path: "/api/integrations/runs/:runId/cancel", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "xyops.run", mutation: "mutation", sameOrigin: false },
  { id: "xyops.runs.rerun", method: "POST", path: "/api/integrations/runs/:runId/rerun", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "xyops.run", mutation: "mutation", sameOrigin: false },
  { id: "xyops.approvals.list", method: "GET", path: "/api/integrations/approvals", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "directory.read", mutation: "read", sameOrigin: false },
  { id: "xyops.approvals.approve", method: "POST", path: "/api/integrations/approvals/:approvalId/approve", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "xyops.approve", mutation: "mutation", sameOrigin: false },
  { id: "xyops.approvals.reject", method: "POST", path: "/api/integrations/approvals/:approvalId/reject", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "xyops.approve", mutation: "mutation", sameOrigin: false },
  { id: "xyops.approvals.cancel", method: "POST", path: "/api/integrations/approvals/:approvalId/cancel", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "xyops.run", mutation: "mutation", sameOrigin: false },
  { id: "xyops.approvals.execute", method: "POST", path: "/api/integrations/approvals/:approvalId/execute", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "xyops.run", mutation: "mutation", sameOrigin: false },
  { id: "xyops.notifications.list", method: "GET", path: "/api/integrations/notifications", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "directory.read", mutation: "read", sameOrigin: false },
  { id: "xyops.notifications.read", method: "POST", path: "/api/integrations/notifications/read", owner: "worker/operations-http-entry.ts", auth: "local-session", permission: "directory.read", mutation: "mutation", sameOrigin: false },

  { id: "xyops.routes.read", method: "GET", path: "/api/integrations/routes", owner: "worker/xyops-admin-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "read", sameOrigin: false },
  { id: "xyops.routes.update", method: "PUT", path: "/api/integrations/routes", owner: "worker/xyops-admin-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "mutation", sameOrigin: true },
  { id: "xyops.presentation.read", method: "GET", path: "/api/integrations/catalog/presentation", owner: "worker/xyops-admin-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "read", sameOrigin: false },
  { id: "xyops.presentation.update", method: "PUT", path: "/api/integrations/catalog/presentation", owner: "worker/xyops-admin-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "mutation", sameOrigin: true },
  { id: "xyops.catalog-policies.read", method: "GET", path: "/api/integrations/catalog/policies", owner: "worker/xyops-admin-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "read", sameOrigin: false },
  { id: "xyops.catalog-policies.update", method: "PUT", path: "/api/integrations/catalog/policies", owner: "worker/xyops-admin-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "mutation", sameOrigin: true },
  { id: "xyops.approval-policies.read", method: "GET", path: "/api/integrations/approval/policies", owner: "worker/xyops-admin-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "read", sameOrigin: false },
  { id: "xyops.approval-policies.update", method: "PUT", path: "/api/integrations/approval/policies", owner: "worker/xyops-admin-http.ts", auth: "admin-or-service-admin", permission: "settings.manage", mutation: "mutation", sameOrigin: true },
