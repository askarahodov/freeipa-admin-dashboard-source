...
test("API reference tracks known literal storage route constants", async () => {
  const [api, status, integrity, preflight, apply] = await Promise.all([read("docs/reference/API.md"), read("storage-status-contract.ts"), read("storage-integrity-contract.ts"), read("storage-migration-preflight-contract.ts"), read("storage-migration-apply-contract.ts")]);
