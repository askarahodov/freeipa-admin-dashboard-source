...
COPY --from=build --chown=dashboard:dashboard /app/scripts/config-encryption-key.mjs /app/scripts/identity-startup-policy.mjs /app/scripts/freeipa-gateway.mjs /app/scripts/http-security.mjs /app/scripts/node-runtime-http.mjs /app/scripts/node-worker-host.mjs /app/scripts/outbound-proxy-policy.mjs /app/scripts/trusted-proxy-policy.mjs /app/scripts/start-production.mjs ./scripts/
USER dashboard
EXPOSE 3001
