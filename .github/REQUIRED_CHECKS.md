...
Branch protection for `main` should require both contexts. Dynamic matrix job names should not be configured as individual required checks; `CI / Required CI` is the stable aggregate for them.
